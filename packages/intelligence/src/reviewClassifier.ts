...
const IMPROVEMENT_AREAS: Category[] = [
  ...
  { label: "Accuracy Failure", keywords: ["inaccurate", "not accurate", "completely wrong", "totally wrong", "wildly wrong", "wrong results", "wrong answer marked", "marked wrong", "marked incorrect", "data is wrong", "numbers are wrong", "count is wrong", "miscounted", "miscounts", "doesn't track properly", "doesn't count", "errors in", "full of errors", "mistranslation", "mistranslated", "wrong translation"] },
  ...
  { label: "Notification Fatigue", keywords: ["too many notifications", "constant notifications", "notification spam", "spams me", "guilt trip", "guilt trips", "passive aggressive", "won't stop reminding", "turn off notifications", "turn off the notifications", "turn off the daily", "stop the notifications", "stop sending", "endless reminders", "daily reminders", "keeps notifying", "notifications won't stop", "bombards me"] },
